...
- **Tone**: 막장 사이다, 통쾌한 먼치킨 무협
- **NPCs**: 장노인(떠돌이 술꾼 고수), 독고련(냉혈 여검객), 소매화(정보상 기녀)
- **Locations**: 화산파 본산, 낙양 야시장, 혈마골, 천잠교
- **Jobs**: 검객, 의원, 암기사, 권법가

#### 🌍 은하 끝에서 살아남기

- **Tone**: 긴장감 넘치는 우주 생존물, 자원 부족과 선택의 연속
- **NPCs**: 제이크(용병 파일럿), 다크라(AI 항해사), 키라(밀수업자)
- **Locations**: 아르칸디아 정거장, 코렐리스 폐허, 네뷸라 암시장, 제로포인트
- **Jobs**: 파일럿, 기력 수호자, 엔지니어, 현상금 사냥꾼

#### 🌍 최하급 마법사의 역습

- **Tone**: 바닥에서 시작하는 언더독 성장물, 무시당하다 각성
- **NPCs**: 엘드릭(은퇴한 대마법사), 루나(라이벌 수석), 그림즈(금지구역 관리인)
- **Locations**: 아칸 학원, 금지된 도서관, 실버우드 숲, 원소 시험장
- **Jobs**: 원소 마법사, 부적술사, 마법생물학자, 연금술사

#### 🌍 퇴사한 개발자, 이세계 왕국을 리팩토링하다

- **Tone**: 현대 개발자가 이세계에 전송, IT 지식으로 왕국을 혁신하는 코미디 전직물
- **NPCs**: 엘라리온(버그투성이 왕국의 왕), 두린(레거시 시스템 같은 대장장이), 마르쿠스(스택오버플로우 같은 현자)
- **Locations**: 에버글레이드 왕성, 깊은뿌리 광산, 실버크라운 시장, 섀도우스파이어 던전
- **Jobs**: 시스템 아키텍트(기사), 풀스택 마법사, 데이터 연금술사, DevOps 레인저
